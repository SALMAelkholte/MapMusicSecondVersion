...
<body>
  ...
  <center><div style="color: white;">Nouvelle Partie -Liste des clients avec les mêmes musiques</div></center>
  ...
  <nav style="background: rgb(46, 46, 46);"  class="navbar navbar-expand-lg navbar-light" style="background-color: #0000009e;">
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item active">       <a class="nav-link" href="MemeMusique.php" style="color: red;">Même musiques</a></li>
      </ul>
    </div>
  </nav>
      ...
      echo'<section style="background: rgb(46, 46, 46);"  class="map-app-latest-epiosodes section-padding-80">';
        echo'<div class="container">';
          echo'<ul class="list-group">';
            echo'<li class="list-group-item changecolor active">Listes commun</li>';
              getClientCommun($_SESSION['client'][4]);
          echo'</ul>';
        echo'</div>';
      echo'</section>';
    }else{
