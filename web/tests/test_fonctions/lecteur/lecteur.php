<div id="audioPlayer">
    ...
    <div id="controls">
        <div id="repeatButton" data-repeat="none"><img src="lecteur/img/repeat/white/repeat-none.svg"></div>
    ...
    <div id="loadingDiv">
        <img id="loadingAnim" src="lecteur/img/loading.gif" alt="Loading">
    </div>

    <div id="playlistControl">
        <div id="audioInputDiv">
            <input id="audioInput" type="text" name="audioInput"
                   placeholder="Direct Audio Stream URL (Direct URL to file download). mp3fiber.com can be used to get such a URL">
...
<script src="lecteur/jquery.knob.min.js"></script>
...
<script>
    ...
    var audioPlayer = {
        ...
        repeatIco: {
            ...
            one: "lecteur/img/repeat/white/repeat-1.svg",
            all: "lecteur/img/repeat/white/repeat-all.svg"
        },
        tickTen: null,
        volume: 1,
